...
const SearchCard = ({ Data }) => {
  return (
    <div className="flex flex-col  items-center bg-[#10172a] h-80 w-65 md:w-115 rounded-2xl px-4 py-3 mb-5 ml-3 mr-3 overflow-wrap break-word border border-gray-700 duration-200 transform hover:-translate-y-1 hover:border-none">
      {/* This is div 1 */}
      <div className="grid grid-cols-1 md:grid-cols-2  mb-3  break-words whitespace-normal w-full">
        ...
        <div>
          <h3>
            Name:<span className=" text-[#3b82f6] font-extrabold">{Data.name}</span>
          </h3>
